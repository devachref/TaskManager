      ...
      <Tabs tabs = {TABS} setSelected={setSelected}>
        {
          ...
          <div className="w-full flex flex-col md:flex-row gap-5 2xl:gap-8 bg-white shadow-md p-8 overflow-y-auto">
            ...
            <div className="w-full md:w-1/2 space-y-8">
              ...
              <div className='flex items-center gap-8 p-4 border-y border-gray-200'>
                ...
                <div className="space-y-4 py-6">
                  <p className="text-gray-600 font font-semibold test-sm">
                    TASK TEAM
                  </p>
            ...
            <div className="w-full grid grid-cols-2 gap-4">{task?.assets?.map((el, index) => (
    ...
    return (
      ...
      <div className='flex flex-col gap-y-1 mb-8'>
        ...
        <div className='text-gray-500 space-y-2'>
          ...
          <span className='px-2 text-sm'>{moment(item?.date).fromNow()}</span>
        </div>
        ...
        <div className='w-full flex flex-wrap gap-5'>
          ...
          {isLoading ? (
            ...
            <Button
              ...
              className='bg-blue-600 text-white rounded 2xl:py-2.5 2xl:px-2.5'
            />
          )}
        </div>
      </div>
